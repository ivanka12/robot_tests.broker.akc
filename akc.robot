...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'akc_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  akc.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Скасувати закупівлю
  ...
  akc.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid} 
...
Перейти на сторінку тендера
  ...
  Run Keyword Unless  ${present}  akc.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Отримати інформацію про dgfDecisionDate
  ...
  ${return_value}=  akc_service.convert_date  ${date_value}
  [return]  ${return_value}
...
Додати предмет закупівлі
  ...
  akc.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  akc.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Дискваліфікувати постачальника
  ...
  akc.Оновити сторінку з тендером  ${username}  ${tender_uaid}
  ${award_index}=  inc  ${award_index}
